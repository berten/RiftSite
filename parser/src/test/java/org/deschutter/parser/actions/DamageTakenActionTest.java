...
public class DamageTakenActionTest {
    ...
    private AttackAction attackAction = new DamageTakenAction("Nilus", "Murdantix", "skill", 1, 2, DamageTypeEnum.LIFE, Boolean.TRUE, new Integer(12), new Integer(13), new Integer(14));
