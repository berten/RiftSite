 ...
 * @author berten
 */
public class DamageTakenParserTest {

    DamageTakenParser parser;
    ...
    public void setUp() {
        ...
        when(parsedLine.getTargetIsInRaid()).thenReturn(Boolean.TRUE);
        parser = new DamageTakenParser();
    ...
    public void actorNotInRaid_cantHandle() {
        when(parsedLine.getTargetIsInRaid()).thenReturn(Boolean.FALSE);
        assertFalse(parser.canHandle(parsedLine));
    }

    @Test
    public void returnsCorrectType() {
        assertTrue(parser.handle(parsedLine) instanceof DamageTakenAction);
    }
